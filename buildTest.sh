...
echo -ne "  UI index: "
if [ ! -f ./ui/dist/index.ts ]; then echo -e "${RED}Not Found${NC}" && exit 1; else echo -e "${GREEN}Found${NC}"; fi
...
if [ ! -f ./branding/dist/index.ts ]; then echo -e "${RED}Not Found${NC}" && exit 1; else echo -e "${GREEN}Found${NC}"; fi
